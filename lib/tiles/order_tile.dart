...
class OrderTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
          ...
          builder: (context, snapshot){
            if(!snapshot.hasData){
              ...
              return Column(
                ...
                children: <Widget>[
                  Text("Codigo do pedido: ${snapshot.data.documentID}", style: TextStyle(fontWeight: FontWeight.bold),),
                  SizedBox(height: 4,),
                  Text(
    ...
    Widget _buildCircle(String title, String subtitle, int status, int thiStatus){
        Color backColor;
        Widget child;
