...
class CartModel extends Model{
  ...
  Future<String> finishOrder() async {
    ...
    DocumentReference refOreder = await Firestore.instance.collection('orders').add(
      {
    ...
    .collection('orders').document(refOreder.documentID).setData({
      'orderID' : refOreder.documentID
    });
